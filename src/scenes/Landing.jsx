    ...
    >
      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          <img
            alt="profile"
            className="z-10 w-full max-w-[300px] md:max-w-[600px] max-h-[400px]"
            src="../assets/profile-image.png"
          />
        )}
          </div>
          ...
          >
          <p className="text-6xl font-playfair z-10 xs:text-center justify-center md:text-start ">
            jane {""}
          ...
          <p className="mt-10 mb-7 text-sm  justify-start md:text-start sm:text-center xs:text-center">
